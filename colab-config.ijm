...
*
* PARAMETER: FPN_CLASSIF_FC_LAYERS_SIZE = 512
*
*
...
* PARAMETER: RPN_ANCHOR_SCALES = (16, 32, 64, 128, 256)
*
*
...
* PARAMETER: RPN_TRAIN_ANCHORS_PER_IMAGE = 64
*
*
...
* PARAMETER: IMAGE_RESIZE_MODE = crop
...
*
* Image mean (RGB)
* PARAMETER: MEAN_PIXEL = [43.53, 39.56, 48.22]
*
*
...
* PARAMETER: TRAIN_ROIS_PER_IMAGE = 128
*
*
...
* PARAMETER: DETECTION_MAX_INSTANCES = 200
*
*
* Minimum probability value to accept a detected instance
* PARAMETER: DETECTION_MIN_CONFIDENCE = 0.0
*
*
